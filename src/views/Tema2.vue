...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5(data-aos="fade-up") Al ser un documento de carácter contractual, el registro hotelero genera unas obligaciones y derechos que las partes deben cumplir.    


    #t_2_1.titulo-segundo
      h2 2.1 Obligaciones y derechos del prestador de servicios
    
    p.mb-4(data-aos="fade-left") Todos los prestadores de servicios turísticos tienen obligaciones y derechos. Es necesario conocerlos y estudiarlos.

    h3.titulo-tercero Prestador de servicios turísticos
    p.mb-3(data-aos="slide-left")  Es toda persona natural o jurídica que habitualmente proporcione, intermedie o contrate directa o indirectamente con el turista la prestación de servicios turísticos y que se encuentre inscrito en el Registro Nacional de Turismo.
    p.mb-5(data-aos="slide-right")  Conforme la normatividad legal vigente, son obligaciones de los prestadores de servicios turísticos:
